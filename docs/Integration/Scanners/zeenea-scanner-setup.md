...
If you decide to download the Scanner using the API, you have to create a dedicated API key. See [Managing API Keys](../../Features/zeenea-administration/zeenea-managing-api-keys.md).
...
The Scanner authenticates itself to the platform with an "Scanner" type API key containing a pair of information (id and secret). To generate an API key, refer to [Managing API Keys](../../Features/zeenea-administration/zeenea-managing-api-keys.md).
...
Learn how to [create, manage or delete a connection](../../Features/zeenea-administration/zeenea-managing-connections.md).
