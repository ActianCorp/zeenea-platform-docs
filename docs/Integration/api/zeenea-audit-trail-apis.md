...
1. Create a new API key in Zeenea Administration. For detailed steps, see [Create an API key](../../Features/zeenea-administration/zeenea-managing-api-keys.md#create-an-api-key).
