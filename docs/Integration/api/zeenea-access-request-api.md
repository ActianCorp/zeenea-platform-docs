...
To create the API Key, follow the instructions in [Create an API key](../../Features/zeenea-administration/zeenea-managing-api-keys.md#create-an-api-key).
...
| 404 | Request not found | The provided accessRequestKey is invalid. | See [Error Example 2](#error-example-2-request-not-found-404) |
