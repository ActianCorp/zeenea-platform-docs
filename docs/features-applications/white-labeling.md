...
Email branding supports limited customization through webhook integration. For more information about configuring webhooks, see [Managing Notifications](./administration/managing-notifications.md).
