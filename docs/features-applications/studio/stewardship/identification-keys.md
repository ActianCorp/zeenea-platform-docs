...
* When an item is imported using a scanner, its key is generated based on data source information. A data source is automatically associated with each imported item. For more information about data sources, see [Definitions](../../../getting-started/definitions.md#data-source).
...
Keys are used to uniquely identify each object of the catalog when [importing](./studio-import.md)/[exporting](./studio-search-export.md) an Excel File. 
