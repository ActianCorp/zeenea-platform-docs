...
* **Name**: Appears on the Explorer home page.
* **Description**: Helps Explorer users understand the Topic.
...
2. Select the Topic to open it.<br />The Catalog opens with its filters applied.
...
1. Go to the **Topics** section in the Studio.
2. Select a Topic to open it.<br />The Catalog opens with its filters applied.
3. Adjust the filters as needed.
