...
![](./images/studio-search.png)

## Using the Search Engine

The search engine works in a way similar to Internet search engines. 

For each item in the Catalog, Studio indexes the following information: 
...
## Filter Your Searches in Studio

Find the filters in the Catalog section of Studio.
