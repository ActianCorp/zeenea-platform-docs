...
Explorer wants to further support users' exploratory approaches, beyond our search capabilities based on metadata indexing, scoring and filtering, already present in our first application Studio.

![](./images/explorer.png)

## Who is Explorer for?

Explorer is aimed directly at data teams, the end consumers of company data.
...
See [Explorer Overview](https://www.loom.com/share/38882344634f432690f40256c7b624d3?t=3).
