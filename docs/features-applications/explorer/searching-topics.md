...
Topics are pre-defined filtered queries that allows you to search in a subset of your catalog items. Topics are created by the catalog curators in Studio to propose search and explore entry-points to end-users in relation with your organization context.

## Browsing the Topics List

You can access to the list of Topics that are available for your organization from Explorer home page.
