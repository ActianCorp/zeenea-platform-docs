...
In general, this description is entered into Studio by the Item's Curator.
...
However, in the case of an Item harvested from a storage system (Datasets, Visualizations, etc.), a description directly provided by the source can be used.
  ...
  ![](./images/details-description.png)

## Glossary

These terms are filled in from Studio by its users and bring a business outlook.

  ![](./images/details-glossary.png)

### Properties

This section contains the information/properties managed by Studio. 

The featured properties can be of two kinds: 

* Business properties: they are filled in according to the metamodel configured in Studio.
...
For more details, see [View 360 Diagram](../cross-application-features/view-360-diagram.md).
...
For more details, see [Data Lineage](../cross-application-features/data-lineage.md).
...
* Summary: a description filled in from Studio
...
* **data profiling**: For Fields in the overview. For more information, see [Data Profiling](../cross-application-features/data-profiling.md).
* **sample data**: For more information, see [Data Sampling](../cross-application-features/data-sampling.md).
...
They provide information about the other items in the catalog to which they are linked and give a business outlook. 
  ...
  ![](./images/details-glossary-items.png)
...
For more details, see [Hierarchical Graph of a Glossary Item](../cross-application-features/glossary-hierarchy.md).
