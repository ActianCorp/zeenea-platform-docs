...
You can mark an item as a favorite from multiple locations in Explorer:
...
* **From the Search Results Page**
     ...
     ![](./images/favorite-items-search-results-page.png)
* **From the Item Details Page**
     ...
     ![](./images/favorite-items-item-details-page.png)
* **From the Side Overview Panel**
     ...
     ![](./images/favorite-items-side-overview-panel.png)
...
1. Click the search bar dropdown in Explorer.
2. Select **Favorite Items** from the dropdown list.<br />Your list of favorite items appears.
![](./images/favorite-items-view.png)
...
![](./images/favorite-items-remove.png)