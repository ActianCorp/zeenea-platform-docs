...
4. When the updates are complete, activate the **Draft** version. For more information, see [Activate a Contract](data-contract-builder-validate-activate.md#activate-a-contract).
