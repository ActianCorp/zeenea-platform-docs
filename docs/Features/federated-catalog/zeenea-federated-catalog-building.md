...
From scanner version 79, some connectors support feeding different catalogs from the same connection using [Universal Filters](../../Integration/Scanners/zeenea-universal-filters.md).
...
* [SCIM API](../../Integration/api/zeenea-scim-api.md)
