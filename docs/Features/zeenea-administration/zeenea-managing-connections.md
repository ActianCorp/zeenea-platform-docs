...
!!! note
    * For more information about scanner installation, see [Zeenea Scanner Setup](../../Integration/Scanners/zeenea-scanner-setup.md).
    * Go to the specific documentation of each connector to identify the prerequisites and the conditions of implementation: [Zeenea Connector Downloads](../../Integration/Connectors/zeenea-connectors-list.md).
