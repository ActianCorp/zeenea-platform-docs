...
For more information about configuring the glossary metamodel, see [Configuring the Glossary Metamodel](../catalog-design/zeenea-studio-configure-glossary-model.md).
...
For more information about submitting a suggestion, see [Submitting a Suggestion](../../zeenea-explorer/zeenea-submit-suggestion.md).
