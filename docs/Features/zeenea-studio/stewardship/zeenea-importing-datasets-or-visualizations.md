...
These steps are described in the sections: [Zeenea Scanner Setup](../../../Integration/Scanners/zeenea-scanner-setup.md) & [Managing Connections](../../zeenea-administration/zeenea-managing-connections.md).
