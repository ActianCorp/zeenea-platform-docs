...
For more details, see [View 360 Diagram](../cross-application-features/zeenea-view-360-diagram.md).
...
For more details, see [Data Lineage](../cross-application-features/zeenea-data-lineage.md).
...
* **data profiling**: For Fields in the overview. For more information, see [Data Profiling](../cross-application-features/zeenea-data-profiling.md).
* **sample data**: For more information, see [Data Sampling](../cross-application-features/zeenea-data-sampling.md).
...
For more details, see [Hierarchical Graph of a Glossary Item](../cross-application-features/zeenea-glossary-hierarchy.md).
