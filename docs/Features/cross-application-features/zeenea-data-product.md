...
* Synchronize data products and their data contracts from your CI/CD pipelines by using our dedicated [Data Product API](../../Integration/api/zeenea-data-product-api.md).
...
For detailed API specification, see [Data Product API](../../Integration/api/zeenea-data-product-api.md).
