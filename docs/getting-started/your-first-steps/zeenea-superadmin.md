...
* Read more: [Configuring Templates](../../Features/zeenea-studio/catalog-design/zeenea-configuring-templates.md)
* Read more: [Creating or Deleting a Custom Item Type](../../Features/zeenea-studio/catalog-design/zeenea-studio-create-delete-custom-item.md)
* Read more: [Adding Input and Output Types to Data Processes](../../Features/zeenea-studio/catalog-design/zeenea-add-input-output-types.md)
...
Read more: [Configuring the Glossary Metamodel](../../Features/zeenea-studio/catalog-design/zeenea-studio-configure-glossary-model.md)
...
Read more: [Creating, Editing, or Deleting Responsibilities](../../Features/zeenea-studio/catalog-design/zeenea-studio-create-delete-responsibility.md)
