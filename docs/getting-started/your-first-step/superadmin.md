...
* Read more: [Configuring Templates](../../features-applications/studio/catalog-design/configuring-templates.md)
* Read more: [Creating or Deleting a Custom Item Type](../../features-applications/studio/catalog-design/studio-create-delete-custom-item.md)
* Read more: [Adding Input and Output Types to Data Processes](../../features-applications/studio/catalog-design/add-input-output-types.md)
...
Read more: [Configuring the Glossary Metamodel](../../features-applications/studio/catalog-design/studio-configure-glossary-model.md)
