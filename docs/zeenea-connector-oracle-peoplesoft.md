...
<table>
  ...
  <tr>
    <td>`connector_id`</td>
    <td>The type of connector to be used for the connection. Here, the value must be `safyr-peoplesoft` and this value must not be modified.</td>
  </tr>
  <tr>
    <td>`input.folder	`</td>
