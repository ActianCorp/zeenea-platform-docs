...
The latest version of the Azure Synapse Analytics connector plugin is available for download from the [Connector Downloads](../zeenea-connectors-list.md) page.
