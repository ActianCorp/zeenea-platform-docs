...
!!! note
    * To connect Actian Data Intelligence to PeopleSoft, Actian provides a collaborative solution with Silwood Technology and its Safyr software. This integration must be validated with our customer services.
...
The Silwood Safyr plugin plugin can be downloaded here: [Connector Downloads](../connectors-list.md# "title: Connector Downloads").
