...
1. Download the latest version of the connector from [Connector Downloads](./zeenea-connectors-list.md).
2. Stop the scanner.
3. Move the downloaded `connector-plugin-1.0.zip` file directly into the `plugins` folder of your scanner.     
...
5. In case of installing a new connector, configure the new connector as specified in its dedicated documentation. 
    ...
    !!! note
        You can find links to all connector configuration documentation in [Connector Downloads](./zeenea-connectors-list.md).
