...
!!! warning "Attention"
    ...
    **Important:** Any documentation manually added to SAP BO visualizations or their embedded datasets is attached to the  existing assets and is **not** carried over during reimport.
