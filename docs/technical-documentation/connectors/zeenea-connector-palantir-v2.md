...
The Palantir connector benefits from the feature of universal filters in the configuration of the connector. This filter is compatible only with the "collection" key to filter the values of the collected metadata.

Read more: [Filters](../scanners/zeenea-universal-filters.md)
