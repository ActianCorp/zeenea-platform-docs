...
1. Download the latest version of the connector from [Connector Downloads](./connectors-list.md).
2. Stop the scanner.
...
5. In case of installing a new connector, configure the new connector as specified in its dedicated documentation. 
    ...
    !!! note
        You can find links to all connector configuration documentation in [Connector Downloads](./connectors-list.md).
