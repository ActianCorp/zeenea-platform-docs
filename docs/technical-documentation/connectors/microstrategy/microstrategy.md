...
|---|---|
| [BigQuery](../google-bigquery/google-bigquery.md) | BigQuery project identifier. Example: `alias = ["project_id"]` |
| [PostgreSQL](../postgresql/postgresql.md), [Oracle](../oracle/oracle.md), [Redshift](../aws-redshift/aws-redshift.md), [SQLServer](../sqlserver/sqlserver.md) | Database address. Example: `alias = ["host:port/database"]` |
