...
|---|---|
| [BigQuery](../google-bigquery/google-bigquery.md) | `bigquery.googleapis.com/{project name}` |
| [Snowflake](../snowflake/snowflake.md) | `{snowflake account name}.snowflakecomputing.com/{database name}` |
