...
Actian Data Intelligence considers with the greatest attention and seriousness the risks induced by the security flaws that can be discovered on the solutions or libraries used in our products.
...
For each published CVE, if it affects any part of Actian Data Intelligence technical ecosystem (\*\*), we consider the following cases:
