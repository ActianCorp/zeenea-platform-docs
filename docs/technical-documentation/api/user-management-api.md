...
* **List permission sets**
      * `listPermissionSets` [Deprecated. See [SCIM API](./scim-api.md).]
* **Create or update a user**
     * `createUser` [Deprecated. See [SCIM API](./scim-api.md).]
     * `upsertUser` [Deprecated. See [SCIM API](./scim-api.md).]
* **Retrieve the information about a user**
     * `loadUserById` [Deprecated. See [SCIM API](./scim-api.md).]
     * `loadUserByEmail` [Deprecated. See [SCIM API](./scim-api.md).]
     * `createAllUsersExport`
     * `loadUsersExportStatus`
* **Delete a user**
     * `deleteUserById` [Deprecated. See [SCIM API](./scim-api.md).]
     * `deleteUserByEmail` [Deprecated. See [SCIM API](./scim-api.md).]
