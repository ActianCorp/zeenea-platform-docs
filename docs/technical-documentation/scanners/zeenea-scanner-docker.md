...
1. Create four folders wherever you want:<br>
...
3. Modify `application.conf` as needed. See [Managing Scanners](../../features-applications/administration/zeenea-managing-scanners.md).
