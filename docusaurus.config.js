...
const config = {
  ...
  url: 'https://zeenea-platform-docs.netlify.app/', // Netlify
  ...
  projectName: 'zeenea-platform-docs', // Usually your repo name.
  trailingSlash: false,
  ...
  themeConfig:
    ...
    ({
            ...
            items: [
              {
                html: `
                    ...
                    <div class="footerColumn-right">
                      ...
                      &nbsp;
                      <a href="https://github.com/ActianCorp/zeenea-platform-docs/tree/suggestions" target="_blank">
      ...
      algolia: {
        ...
        apiKey: '2747fb2840cd67ed3ece4b6f8cfed1c1',
