...
Since scanner version 26.9, the Elasticsearch plugin can be downloaded here: [Zeenea Connector Downloads](./zeenea-connectors-list).
...
<table>
  ...
  <tr>
    <td>`connector_id`</td>
    <td>The type of connector to be used for the connection. Here, the value must be `Elasticsearch` and this value must not be modified.</td>
  </tr>
  <tr>
