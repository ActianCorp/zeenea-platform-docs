...
![](./images/data-profiling1.png)

![](./images/data-profiling2.png)
...
* Data Profiling has been enabled in every field where it is relevant. This is done by Data Stewards, on Studio, using the option "Activate Data Profiling for this Field".

![](./images/data-profiling3.png)

![](./images/data-profiling4.png)
