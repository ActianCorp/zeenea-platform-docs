...
To manage agents, you must have the **Manage agents** permission. Grant this permission to a Data Steward-type group on the **Edit group** page. For more information, see [Managing Groups](./managing-groups.md). 
...
* **From the group**: On the **Edit group** page, use the **Agent access** section to grant a Data Steward-type group permission to use the Steward agent. For more information, see [Managing Groups](./managing-groups.md).
