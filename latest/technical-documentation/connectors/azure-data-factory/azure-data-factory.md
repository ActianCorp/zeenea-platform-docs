...
The Azure plugin can be downloaded here: [Connector Downloads](../zeenea-connectors-list.md).
...
| [ADLS](../azure-data-lake/azure-data-lake.md) | Storage account.dfs.core.windows.net | `alias = [".dfs.core.windows.net"]` |
